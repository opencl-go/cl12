...
// #include "api.h"
// extern CL_CALLBACK void cl12CContextErrorCallback(char const *errorInfo,
...
func cContextErrorCallbackFunc() unsafe.Pointer {
	return C.cl12CContextErrorCallback
}

//export cl12GoContextErrorCallback
func cl12GoContextErrorCallback(errorInfo *C.char, privateInfoPtr *C.uint8_t, privateInfoLen C.size_t, key C.intptr_t) {

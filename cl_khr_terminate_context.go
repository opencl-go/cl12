...
// #include "api.h"
// extern cl_int cl12ExtTerminateContextKHR(void *fn, cl_context context);
import "C"
...
//
// See also: https://registry.khronos.org/OpenCL/sdk/1.2/docs/man/xhtml/cl_khr_terminate_context.html
...
// terminated.
//
// See also: https://registry.khronos.org/OpenCL/sdk/1.2/docs/man/xhtml/clTerminateContextKHR.html
// Extension: KhrTerminateContextExtensionName
func (ext *ExtensionTerminateContextKhr) TerminateContext(context Context) error {
	...
	status := C.cl12ExtTerminateContextKHR(ext.clTerminateContextKhr, context.handle())

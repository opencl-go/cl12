...
// #include "api.h"
// extern cl_int cl12BuildProgram(cl_program program,
//    cl_uint numDevices, cl_device_id *devices,
//    char *options, uintptr_t *userData);
// extern cl_int cl12CompileProgram(cl_program program,
//    cl_uint numDevices, cl_device_id *devices,
//    char *options,
//    cl_uint numInputHeaders, cl_program *headers, char **includeNames,
//    uintptr_t *userData);
// extern cl_program cl12LinkProgram(cl_context context,
//    cl_uint numDevices, cl_device_id *devices,
//    char *options,
//    cl_uint numInputPrograms, cl_program *programs,
//    uintptr_t *userData,
//    cl_int *errReturn);
// extern cl_int cl12SetProgramReleaseCallback(cl_program program, uintptr_t *userData);
import "C"
import (
	"fmt"
	"unsafe"
...
//
// Since: 1.2
// See also: https://registry.khronos.org/OpenCL/sdk/1.2/docs/man/xhtml/clCreateProgramWithBuiltInKernels.html
...
//export cl12GoProgramBuildCallback
func cl12GoProgramBuildCallback(_ Program, userData *C.uintptr_t) {
...
//
// Since: 1.2
// See also: https://registry.khronos.org/OpenCL/sdk/1.2/docs/man/xhtml/clCompileProgram.html
...
//export cl12GoProgramCompileCallback
func cl12GoProgramCompileCallback(_ Program, userData *C.uintptr_t) {
	callbackUserData := userDataFrom(userData)
	callback := callbackUserData.Value().(func())
	callbackUserData.Delete()
	callback()
...
//
// Since: 1.2
// See also: https://registry.khronos.org/OpenCL/sdk/1.2/docs/man/xhtml/clLinkProgram.html
...
//export cl12GoProgramLinkCallback
func cl12GoProgramLinkCallback(program Program, userData *C.uintptr_t) {
	callbackUserData := userDataFrom(userData)

...
// #include "api.h"
// extern cl_context cl12CreateContext(cl_context_properties *properties,
//     cl_uint numDevices, cl_device_id *devices,
//     uintptr_t *userData,
//     cl_int *errcodeReturn);
// extern cl_context cl12CreateContextFromType(cl_context_properties *properties,
...
// active.
//
// See also: https://registry.khronos.org/OpenCL/sdk/1.2/docs/man/xhtml/clCreateContextFromType.html
func CreateContextFromType(deviceType DeviceTypeFlags, callback *ContextErrorCallback, properties ...ContextProperty) (Context, error) {
	...
	var status C.cl_int
	context := C.cl12CreateContextFromType(
		(*C.cl_context_properties)(rawProperties),
...
//export cl12GoContextErrorCallback
func cl12GoContextErrorCallback(errorInfo *C.char, privateInfoPtr *C.uint8_t, privateInfoLen C.size_t, key *C.uintptr_t) {

...
// #include "api.h"
// extern cl_int cl12SetEventCallback(cl_event event, cl_int callbackType, uintptr_t *userData);
import "C"
import (
	"fmt"
	"unsafe"
...
//
// See also: https://registry.khronos.org/OpenCL/sdk/1.2/docs/man/xhtml/clCreateUserEvent.html
...
//
// See also: https://registry.khronos.org/OpenCL/sdk/1.2/docs/man/xhtml/clSetUserEventStatus.html
...
//
// See also: https://registry.khronos.org/OpenCL/sdk/1.2/docs/man/xhtml/clGetEventInfo.html
...
// Raw strings are with a terminating NUL character.
//
// See also: https://registry.khronos.org/OpenCL/sdk/1.2/docs/man/xhtml/clGetEventProfilingInfo.html
...
// has been reached.
//
// See also: https://registry.khronos.org/OpenCL/sdk/1.2/docs/man/xhtml/clSetEventCallback.html
func SetEventCallback(event Event, callbackType EventCommandExecutionStatus, callback func(error)) error {
	...
	status := C.cl12SetEventCallback(event.handle(), C.cl_int(callbackType), callbackUserData.ptr)
	if status != C.CL_SUCCESS {
...
//export cl12GoEventCallback
func cl12GoEventCallback(_ Event, commandStatus C.cl_int, userData *C.uintptr_t) {
...
//
// Since: 1.2
// See also: https://registry.khronos.org/OpenCL/sdk/1.2/docs/man/xhtml/clEnqueueMarkerWithWaitList.html
...
//
// Since: 1.2
// See also: https://registry.khronos.org/OpenCL/sdk/1.2/docs/man/xhtml/clEnqueueBarrierWithWaitList.html
